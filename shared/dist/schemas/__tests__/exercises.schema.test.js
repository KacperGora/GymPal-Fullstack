...
import { wgerExerciseSchema, wgerCategorySchema, wgerMuscleSchema, wgerEquipmentSchema, wgerPaginatedSchema, createFavoriteExerciseSchema, } from "../exercises.schema.js";
...
describe("createFavoriteExerciseSchema", () => {
    ...
    it("should reject non-positive wgerExerciseId", () => {
        expect(() => createFavoriteExerciseSchema.parse({ ...valid, wgerExerciseId: -1 })).toThrow();
    });
    it("should reject empty name", () => {
        expect(() => createFavoriteExerciseSchema.parse({ ...valid, name: "" })).toThrow();
    });
    it("should reject empty category", () => {
        expect(() => createFavoriteExerciseSchema.parse({ ...valid, category: "" })).toThrow();
    });
    it("should reject empty muscles", () => {
        expect(() => createFavoriteExerciseSchema.parse({ ...valid, muscles: "" })).toThrow();
    });
